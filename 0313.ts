...
// // // 타입 좁히기를 통해
// // if(unknownVar === "hello") {
// //     console.log(unknownVar.charAt(0));
// // }
// // if(typeof unknownVar === "number") {
// //     console.log(unknownVar.toFixed());
// // }

// // let unknownVar: unknown;
// // unknownVar = "hello";
// // // as 키워드를 이용하여 string 타입으로 형변환
// // // 자바였다면, (string) unknownVar <= 이런 느낌
// // const s = unknownVar as string;
// // // 이후 string으로 타입을 인식하므로 toUpperCase 메서드 호출 가능
// // s.toUpperCase();
...
// //         // ... number 타입 처리 로직
// //     } else {
// //         // 논리적으로 이 블록으로 진입할 수 없기 때문에, 블록 내부에서 value 값은 never 타입의 값으로 추론됨
// //         // never 타입의 값에는 어떠한 종류의 작업도 수행 불가
// //         // const v = value;
// //         // value = 1234;
// //         // value.toString();
// //     }
...
// // 최종 타입은 "string | number | boolean" 타입
// type MyType = string | number | boolean | never;